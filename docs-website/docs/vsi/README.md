...
### Prerequisites
- **IBM Cloud VPC infrastructure deployed** - See [VPC Infrastructure](../vpc/README.md) for complete VPC foundation setup
  - [VPC Foundation](../vpc/vpc-foundation.md) - Core VPC concepts
  - [Subnet Service](../vpc/subnet-service-internals.md) - Subnet design and configuration
  - [Security Groups](../vpc/security-group-service-internals.md) - Security group architecture
